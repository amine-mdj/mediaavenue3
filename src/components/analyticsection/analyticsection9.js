  ...
  return (
    <div className="ticsec9">
      ...
      <div className="ticsec9-inner">
        ...
        <hr />
        <p>
          Le test de <span>qualification individuelle Google Analytics (IQ)</span> est une certification reconnue dans l'industrie qui démontre la compétence du titulaire sur cette plateforme.
        </p>
        <p>
...
export default Analyticsection9;